const professions = {
          ...
          exclusions(town, npc) {
            if (town.npcRelations) {
              if (town.npcRelations[npc.key]) {
                return !town.npcRelations[npc.key]
                  .map((r) => {
                    return r.relation;
                  })
                  .includes('liege');
  ...
  thief: {
    ...
    sector: 'crime',
    description:
      'steals peoples property, especially by stealth and without using force or violence.',
    dailyWage: 120,
    socialClass: 'paupery',
    socialClassRoll() {
      return 5 + dice(8, 6);
  ...
  sergeant: {
    ...
    sector: 'military',
    description:
      'an officer instructed with a protective duty, typically worth more than other officers.',
    domSub: 'dom',
    dailyWage: 300,
    socialClass: 'commoner',
    socialClassRoll() {
