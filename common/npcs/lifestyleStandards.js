const lifestyleStandards = {
  aristocratic: {
    ...
    lifestyleDescription:
      'lives large, with little care to how much money is spent, splashing out on expensive things on a whim',
    homeBias: 40,
    home: {
      table: [
        [1, 'apartment'],
  ...
  wealthy: {
    ...
    lifestyleDescription:
      'lives lavishly, with fine foods, wines, clothes, and all the comforts money can buy',
    homeBias: 20,
    home: {
      table: [
        [5, 'apartment'],
  ...
  modest: {
    ...
    lifestyleDescription:
      'lives modestly- not without creature comforts of wine and decent food thanks to frugality, though',
    homeBias: 0,
    home: {
      table: [
        [35, 'apartment'],
  ...
  squalid: {
    ...
    lifestyleDescription:
      'lives a squalid existence, eating terrible food with no alcohol, and few creature comforts',
    homeBias: -20,
    home: {
      table: [
        [80, 'apartment'],
  ...
  wretched: {
    ...
    lifestyleDescription:
      'lives a wretched life of constant filth and misery. There is no respite to this poverty',
    homeBias: -40,
    home: {
      table: [
        [80, 'apartment'],
